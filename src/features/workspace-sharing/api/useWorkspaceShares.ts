...
export function useWorkspaceShares(workspaceId: string | null, enabled: boolean, search = "") {
  ...
  return {
    ...
    options: useQuery({ queryKey: ["workspace-share-options", workspaceId, search], enabled: !!workspaceId && enabled, queryFn: () => workspaceSharingApi.options(workspaceId!, search) }),
