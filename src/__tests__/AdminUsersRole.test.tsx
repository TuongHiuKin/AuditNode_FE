...
vi.mock("../features/admin-users/api/useAdminUsers", () => ({ useAdminUsers: () => ({ users: { data: [{ id: "u1", username: "alice", email: "a@x.test", enabled: true, isSystemAdmin: true }], isPending: false, isError: false }, status: { isPending: false, mutate: vi.fn() }, create: { isPending: false, mutateAsync: vi.fn() }, role: { isPending: false, mutateAsync }, size: 25 }) }));
